...
/**
 * Classe:ButtonCelPrenotazione
 * Gestire il pulsante della prenotazione che si trova nel table view  
 */
    ...
    public ButtonCelPrenotazione() {
        ...
        cellButton.setOnAction((ActionEvent t) -> {
            ...
            try {
                ...
                alert.show();
                Main.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/views/PrenotareEsame.fxml"))));
